...
<SCRIPT>
	...
	var submitButton = document.getElementById("submitButton");		//회원가입 폼으로 이동할 버튼 변수
	...
	masterCheckbox.addEventListener('change', function() {
		...
		for (var i = 0; i < slaveCheckboxes.length; i++) {
	    slaveCheckboxes[i].addEventListener('change', function() {
			// 모든 체크박스가 선택되었는지 확인
			var allChecked = true;
			for (var j = 0; j < slaveCheckboxes.length; j++) {
				if (!slaveCheckboxes[j].checked) {
					allChecked = false;
	         		break;
	       		}
			}
