		...
		<div class="distillery_wrap">
			<div class="wrap_box">
				...
				<ul class="wrap_tab">
					...
					<li class="on"><a class="a-main" href="/project/views/qna/qnaList.jsp?pageNum=1">1:1 문의하기</a></li>
...
<%		for( int i = startPage; i <= endPage; i++ ){ %>
		...
		class="on"
		<% } %>>
		<a href="qnaList.jsp?pageNum=<%= i %>"><%= i %></a></li>
<%		}%>
			</ul>
		</div>
<%		if( endPage < pageCount){ %>
...
<div class="btn_right_box">
	<button type="submit" class="btn_write" onclick="window.location='qnaWriteForm.jsp?pageNum=<%=pageNum%>'">
		<strong>문의하기</strong>
	</button>
</div>